...
static func validate_and_prepare(manifest: Dictionary, pack_root: String, prepared: Dictionary, file_index: Dictionary) -> Dictionary:
	...
	_require_keys(manifest, ["schema_version", "pack", "profile", "completeness_policy", "compatibility", "layers", "atlases", "roles", "characters", "runtime", "files", "license", "provenance"], "Pack 0.8 manifest", errors)
